...
const FC_GAMES = [
  { id: "fc1", title: "Far Cry", year: "2004", developer: "Crytek",
    cover: "fc1.png", banner: "fc1.png",
    location: { name: "The Islands", description: "A lush, sprawling tropical archipelago dotted with mercenary camps, hidden coves, and a secret genetic research facility, serving as the series' first sandbox battleground." } },
  { id: "fc2", title: "Far Cry 2", year: "2008", developer: "Ubisoft Montreal",
    cover: "fc2.png", banner: "fc2.png",
    location: { name: "An Unnamed African Nation", description: "A fictional, sun-scorched nation gripped by civil war between two factions, its dusty savannas and diamond mines serving as the backdrop for a conflict neither side is really fighting to win." } },
  { id: "fc3", title: "Far Cry 3", year: "2012", developer: "Ubisoft Montreal",
    cover: "fc3.png", banner: "fc3.png",
    location: { name: "Rook Islands", description: "A lawless tropical archipelago run by pirates and slavers, its beaches and jungle ruins hiding both natural beauty and a thriving trade in human cargo." } },
  { id: "fc4", title: "Far Cry 4", year: "2014", developer: "Ubisoft Montreal",
    cover: "fc4.png", banner: "fc4.png",
    location: { name: "Kyrat", description: "A fictional Himalayan nation of soaring peaks and hidden monasteries, held under the unpredictable rule of a self-declared king while a civil war simmers in its valleys." } },
  { id: "primal", title: "Far Cry Primal", year: "2016", developer: "Ubisoft Montreal",
    cover: "primal.png", banner: "primal.png",
    location: { name: "Oros, 10,000 BCE", description: "An untamed Stone Age valley of dense forests and mammoth-crossed plains, contested by three tribes with very different visions for how to survive in it." } },
  { id: "fc5", title: "Far Cry 5", year: "2018", developer: "Ubisoft Montreal",
    cover: "fc5.png", banner: "fc5.png",
    location: { name: "Hope County, Montana", description: "A fictional slice of rural Montana, all pine forests and river valleys, quietly overtaken county by county by a cult convinced it alone will survive what's coming." } },
  { id: "newdawn", title: "Far Cry New Dawn", year: "2019", developer: "Ubisoft Montreal",
    cover: "newdawn.png", banner: "newdawn.png",
    location: { name: "Hope County, Reborn", description: "The same Montana valleys, seventeen years after a global nuclear exchange, now overgrown with mutated superbloom flora and fought over by resettling survivors and raider gangs alike." } },
  { id: "fc6", title: "Far Cry 6", year: "2021", developer: "Ubisoft Toronto",
    cover: "fc6.png", banner: "fc6.png",
    location: { name: "Yara", description: "A fictional Caribbean island nation modeled on Cuba, its sugarcane fields, colonial cities, and jungle interior all caught in the middle of a revolution." } },
];
