...
const HM_GAMES = [
  ...
  { id: "hitman2", title: "HITMAN™ 2", year: "2018", cover: "hitman2.png", banner: "hitman2.png", logo: "hitman2.png",
    ...
    locations: [
      ...
      { name: "New York", desc: "The New York branch of Milton-Fitzpatrick, the oldest bank in the city, contained a vault which stored the account data of its members, including those of the Providence Partners." },
      { name: "Haven Island", desc: "A small tropical island located on a tiny archipelago in the Maldives, and is home to the remote Haven Resort owned by Haven. The Resort is known to cater to the rich and famous, offering special services in ‘reputation management." },
    ] },
  { id: "hitman3", title: "HITMAN™ III", year: "2021", cover: "hitman3.png", banner: "hitman3.png",  logo: "hitman3.png",
    ...
    locations: [
      {name: "Ambrose Island", desc: "The island consists of rough terrain, being heavily covered with tropical vegetation. Inland, there are high cliffs and deep ravines. Locations include various villages, docks, militia camps, and a cave network." },
